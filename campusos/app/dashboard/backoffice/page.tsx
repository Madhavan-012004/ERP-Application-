...
interface Institution {
  ...
  adminEmail: string;  // auto-generated Super Admin email
  adminId: string;     // login ID
  adminPass: string;   // generated password
...
export default function BackofficePage() {
  ...
  const handleCreate = () => {
    ...
    const inst: Institution = {
      ...
      city: form.city.trim(),
      type: form.type,
      adminEmail: `${adminId}@campusos.io`,
      adminId,
      adminPass,
      status: "Pending",
      createdAt: new Date().toISOString(),
      plan: form.plan,
      studentCap: parseInt(form.studentCap) || 500,
    };
    newList.push(inst);
    ...
    <div className="page-content">
      ...
      <div className="section-header" style={{ marginBottom: 28 }}>
        <div>
          ...
          <p className="section-subtitle">Manage institutions &amp; provision Super Admin credentials</p>
        </div>
                ...
                >
                  ...
                  <td style={{ padding: "14px 16px" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                      <div style={{ width: 34, height: 34, borderRadius: 8, background: "linear-gradient(135deg,rgba(159,161,255,0.2),rgba(174,226,255,0.2))", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, fontSize: 13, fontWeight: 800, color: "#9FA1FF" }}>
                  ...
                  {/* ID */}
                  <td style={{ padding: "14px 16px" }}>
                    <span style={{ fontFamily: "monospace", fontSize: 13, fontWeight: 700, color: "#9FA1FF", background: "rgba(159,161,255,0.1)", padding: "3px 8px", borderRadius: 6 }}>
                      {inst.id}
                    </span>
                  </td>
                  ...
                  <td style={{ padding: "14px 16px" }}>
                    <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
                        <span style={{ fontSize: 11, color: "var(--text-muted)", width: 24 }}>ID</span>
                      ...
                      {/* Password */}
                      <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
                        <span style={{ fontSize: 11, color: "var(--text-muted)", width: 24 }}>PW</span>
                  ...
                  <td style={{ padding: "14px 16px", position: "relative" }}>
                    ...
                    {actionMenu === inst.id && (
                      <div style={{ position: "absolute", right: 0, top: "calc(100% - 4px)", width: 190, background: "var(--bg-card)", border: "1px solid var(--border)", borderRadius: 12, padding: 8, boxShadow: "var(--shadow-lg)", zIndex: 50 }}>
                        {inst.status !== "Active" && (
          ...
          <div style={{ background: "var(--bg-card)", borderRadius: 20, border: "1px solid var(--border)", width: "100%", maxWidth: 520, padding: "32px 36px", boxShadow: "var(--shadow-lg)" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 24 }}>
              ...
              <div>
                ...
                <div style={{ fontSize: 12.5, color: "var(--text-muted)" }}>Credentials will be auto-generated with unique IDs</div>
              </div>
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <div>
                ...
                {form.name && (
                  <div style={{ marginTop: 6, fontSize: 11.5, color: "var(--text-muted)" }}>
                    Admin ID will be: <code style={{ color: "#9FA1FF" }}>admin_{form.name.toLowerCase().replace(/[^a-z0-9]/g, "").slice(0, 8)}</code>
                  </div>
                )}
              </div>
              ...
              <div style={{ padding: "12px 14px", borderRadius: 10, background: "rgba(159,161,255,0.08)", border: "1px solid rgba(159,161,255,0.18)", display: "flex", gap: 10 }}>
                ...
                <p style={{ fontSize: 12, color: "var(--text-secondary)", lineHeight: 1.6, margin: 0 }}>
                  A unique <strong>Admin ID</strong> and secure <strong>password</strong> will be auto-generated. No two institutions will have the same login ID. Share these credentials only with the institution&apos;s administrator.
                </p>
              </div>
            </div>
